...
- Sau đó 2-4 gạch đầu dòng, mỗi dòng bắt đầu bằng "- ".
- Kết bằng 1 câu ngắn.

Ưu tiên phản hồi nhanh và súc tích. Nếu câu hỏi đơn giản, trả lời khoảng 60-120 chữ; nếu câu hỏi phức tạp, vẫn giữ dưới 150 chữ và không vòng vo.`
...
export default function ChatPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Chỉ giữ lại một đoạn lịch sử gần nhất để phản hồi nhanh hơn.
